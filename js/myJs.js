...
// Main
const textConfig = {
  text1: "Một nụ cười luôn hé, thế giới vẫn quay~ 🍀🍀🍀",
  text3: "Lime, take my energy ༼ つ ◕_◕ ༽つ",
  text4: "Dù chuyện đôi mình chẳng thành, em mong chị đừng quên rằng bản thân chị tuyệt vời như thế nào. Nhờ có chị, suốt 5 năm ròng qua, em mới thật sự được tận hưởng cuộc sống ở Sài Gòn. Cảm ơn chị vì đã đến bên đời, người yêu đầu tiên và duy nhất ở Sài Gòn của em, Chanh biết nói.",
  text5: "Chọn khóc",
  text6: "Chọn cười",
  text7: "Nếu mọi thứ có khó khăn quá, và chị cần một người bạn thật sự lắng nghe chị, thì em ở đây",
  text8: "Gửi em",
  text9: "Nothing",
  text10: "Một vài điều em muốn nói",
  text11:
  "Chị xinh nhất lúc cười đấy, đừng quên điều đó nhé",
  text12: "Đến trang của một người xinh đẹp",
};
